	...
	public class Light2DEditor : Editor
	{
		...
		private bool OnScene_FreeForm()
		{
			...
			for(int i = 0; i < points.Count; i++)
			{
				...
				var fmh_201_52_638938248650276469 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
		...
		private bool OnScene_Point()
		{
			...
			var fmh_255_51_638938248650287837 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			var fmh_298_61_638938248650291580 = Quaternion.identity; Vector3 innerHandle = Handles.FreeMoveHandle(innerPoint, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			if (light2D.spotAngleInner < 360)
			{
				...
				var fmh_336_70_638938248650296251 = Quaternion.identity; Vector3 outerHandleLeft = Handles.FreeMoveHandle(outerPointLeft, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
				...
				var fmh_362_72_638938248650300053 = Quaternion.identity; Vector3 outerHandleRight = Handles.FreeMoveHandle(outerPointRight, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
